                        ...
                        <form role="form" action="{{ url('/doLogin')  }}" method="post">
                            <fieldset>
                                <div class="form-group">
                                    @if ($errors->has('email'))
                                        <input class="form-control email" placeholder="Eメール" name="email" type="text" autocomplete="off">
                                    @else
                                        <input class="form-control email" placeholder="Eメール" name="email" type="text" autocomplete="off" value="{{ old('email') }}">
                                    @endif
                                </div>
                                <div class="form-group">
                                ...
                                <input type="hidden" name="before_login_page" value="{{ $before_login_page }}">
                            </fieldset>
                        </form>
                    </div>
                </div>
