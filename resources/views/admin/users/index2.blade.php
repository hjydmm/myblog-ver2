...
<table class="layui-table" lay-data="{height:405,width:1130, method:'post', url:'/api/getUsers', page:true,limit: 10, id:'table'}" lay-filter="table">
  <thead>
    <tr>
      <th lay-data="{field:'id', align:'center',width:80, sort: true}">ID</th>
      <th lay-data="{field:'user_name', align:'center',width:100}">用户名</th>
      <th lay-data="{field:'email', align:'center',width:100}">邮箱</th>
      <th lay-data="{field:'avatar', align:'center',width:80}">头像</th>
      <th lay-data="{field:'city', align:'center',width:100}">来自</th>
      <th lay-data="{field:'type', align:'center',width:100}">类型</th>
      <th lay-data="{field:'gender', align:'center',width:100}">性别</th>
