...
use Cookie;    //暂时先用cookie,基本功能完善后改成redis
use Config;
use Log;
...
class UsersService implements UsersServiceInterface
{
    ...
    {
        return $this->usersRepository->createUserGetId($data);
    }
    ...
    public function updateUser($user_id, array $data){
        ...
        return $this->usersRepository->updateUser($user_id, $data);
    }
    ...
    {
        return $this->adminRepository->batchDeleteUsers($ids);
    }
    ...
    public function publish($request, $id = 0)
    {
        ...
        $data = [
            ...
            'markdown_content' => trim($request->input('markdown_content')),
        ];
